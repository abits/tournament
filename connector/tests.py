...
from connector.models import FootballPool
...
class FootballPoolTestCase(unittest.TestCase):
    ...
    def test_connector_can_fetch_team_info(self):
        ...
        self.assertEqual(self.fp.fetch_team_item(7, 'coach_name'), u'Joachim L\xf6w')
        ...
        self.assertEqual(self.fp.fetch_team_item(9, 'coach_name'), u'Vicente del Bosque')
